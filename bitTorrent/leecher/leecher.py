...
result_A_10kB = download_torrent(file_paths[0], torrent_files[0], 333, 10240)
result_A_100kB = download_torrent(file_paths[1], torrent_files[1], 33, 102400)
result_A_1MB = download_torrent(file_paths[2], torrent_files[2], 3,1048576)
